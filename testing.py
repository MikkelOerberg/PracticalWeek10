...
def run_tests():
    ...
    # and with default:
    test_car = Car()
    assert test_car.fuel == 0, "Car does not set fuel correctly on default"
...
def phrase_as_sentence(phrase):
    """
    Determine if the phrase is now a sentence
    >>> phrase_as_sentence("hello") == "Hello."
    True
    >>> phrase_as_sentence("It is an ex parrot") == "It is an ex parrot."
    True
    >>> phrase_as_sentence("it is my birthday") == "It is my birthday."
    True
    """
